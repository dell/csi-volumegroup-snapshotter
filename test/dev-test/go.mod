module github.com/dell/dell-csi-volumegroup-snapshotter/test/dev-test
...
require (
	...
	github.com/dell/csi-vxflexos v1.4.0
	github.com/dell/dell-csi-volumegroup-snapshotter v0.0.0-00010101000000-000000000000
